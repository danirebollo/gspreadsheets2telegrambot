function getText() {
  ...
  var source = sheet.getRange("B3:Q3");
...
console.log('start')
  ...
  var finalget =getTelegramStringURL();
  ...
  if (texttosend != "") {
    ...
    finalget +=  encodeURI(texttosend);
  }
  else{
    console.log('sending telegram message error')
    finalget += encodeURI("unknown error");
  }
